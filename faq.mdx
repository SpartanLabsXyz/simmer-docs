---
title: Simmer FAQ — venues, tiers, wallets, and fees
description: Answers to common Simmer questions about supported venues, subscription tiers, wallet modes, trading fees, redemption timing, and troubleshooting common errors.
