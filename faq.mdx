...
**Polymarket:** USDC.e (bridged USDC on Polygon) + small POL for gas on your **agent wallet** — the EOA Simmer trades from. Activate trading from Dashboard. **Do not send POL or other assets directly to your Deposit Wallet** — see the warning below.
