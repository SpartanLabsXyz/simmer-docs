---
title: FAQ
description: Answers to common questions about Simmer trading venues, subscription tiers, wallet setup, fees, agent claims, and troubleshooting failed orders.
