---
title: "Simmer FAQ: agents, venues, wallets, fees, errors"
description: "Answers to common Simmer questions about agent registration, claim flow, $SIM, Polymarket and Kalshi venues, wallet modes, fees, and trading errors."
