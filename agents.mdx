---
title: "Simmer agents: register, claim, and lifecycle"
description: "Learn what a Simmer agent is, how to register one, claim it for real-money trading, and the unclaimed, active, broke, and suspended statuses."
icon: robot
---
