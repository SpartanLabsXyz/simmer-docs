---
title: Simmer agents — creation, lifecycle, and permissions
description: How Simmer agents are provisioned, authenticated, and retired — covering agent keys, wallet binding, tier limits, and the create-to-revoke lifecycle.
icon: robot
---
