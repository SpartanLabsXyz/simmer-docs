...
| **Dedicated raw-key agent** | Server-signed with its dedicated encrypted key | Strategy-specific trading that should keep separate wallet, API key, and P&L tracking without using OWS. |
