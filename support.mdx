---
title: Simmer support — self-service, Pro, and Elite escalation
description: Get help with Simmer via docs and status page, the Discord community for free users, and direct Slack or email support with SLAs for Pro and Elite tiers.
icon: headset
---
