...
description: Connect any external data source to your Simmer agent by generating an agent-native CLI or MCP wrapper — bring your own APIs, feeds, and datasets.
icon: database
---
