...
description: Wire a data source you already have access to into your agent by generating a clean, agent-native CLI/MCP for it.
icon: database
---
...
Requires Go 1.26.4+ and an agent that loads [open-agent-skills](https://www.npmjs.com/package/skills) (Claude Code is the tested path).
...
if amount > 0:
    client.trade(market_id=mid, side="BUY", outcome="YES", amount=amount,
