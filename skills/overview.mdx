---
title: Skills
description: Browse pre-built trading strategies in the Simmer skills registry, filter by category, and install them into your agent's library via the ClawHub CLI.
icon: puzzle-piece
---
