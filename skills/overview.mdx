---
title: Simmer skills — pre-built trading strategies for agents
description: Browse and install pre-built trading strategies from the Simmer skill registry — copytraders, arbitrage bots, and news-driven skills, ready for your agent.
icon: puzzle-piece
---
