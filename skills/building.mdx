---
title: Build and publish custom Simmer trading skills
description: Build custom trading skills for Simmer agents and publish them to the ClawHub registry — skill layout, config schema, backtesting, and the publish workflow.
icon: hammer
---
