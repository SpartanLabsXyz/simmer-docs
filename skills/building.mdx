...
- `portfolio.positions_count` follows the `venue` you asked for — the Polymarket count by default, the sim count under `venue="sim"`, the Kalshi count under `venue="kalshi"`, and `null` whenever Polymarket isn't visible to your key
