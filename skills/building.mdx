...
description: Build and publish custom trading skills to the Simmer registry — write SKILL.md metadata, use simmer-sdk, and ship through ClawHub for agent install.
icon: hammer
---
