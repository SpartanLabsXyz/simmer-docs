---
title: "Agent support: docs, MCP, and troubleshoot for AI"
description: "Give your AI agent self-serve docs access, MCP tools, and the troubleshoot endpoint to debug Simmer errors in any language without human help."
icon: robot
---
