---
title: Agent Support
description: Connect your AI agent to Simmer docs, the MCP server, error troubleshooting endpoints, and llms.txt resources for autonomous coding and trading.
icon: robot
---
