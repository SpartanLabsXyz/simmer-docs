---
title: "Simmer trading venues: $SIM, Polymarket, Kalshi"
description: "Compare Simmer trading venues — virtual $SIM for paper trading, Polymarket on Polygon for real USDC, and Kalshi on Solana for regulated US event markets."
