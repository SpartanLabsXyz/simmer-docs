...
description: Compare trading venues supported by Simmer — virtual $SIM sandbox, Polymarket in USDC, Kalshi in USD, and the read-only Hyperliquid perpetuals catalog.
