---
title: Wallet Setup
description: Set up your Simmer wallet for real-money trading — choose between custodial and self-custody modes based on who signs Polymarket and Kalshi transactions.
icon: wallet
---
