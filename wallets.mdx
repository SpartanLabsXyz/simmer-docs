---
title: Wallet setup — delegated and self-custody signing modes
description: Simmer offers two wallet modes for real-money trading — delegated signing where Simmer signs on your behalf, or self-custody where your wallet signs each tx.
icon: wallet
---
