...
|---|---|---|
| Type | Externally-owned account | Smart contract proxy: currently ERC-1967 UUPS on mainnet; Simmer is BeaconProxy-ready for Polymarket's future factory flip |
