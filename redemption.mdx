---
title: Redemption
description: Collect payouts from winning Polymarket and Kalshi positions on Simmer — auto-redeem settings, manual redemption flow, and settlement timing details.
