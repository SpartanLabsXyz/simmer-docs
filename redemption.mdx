...
<Steps>
  ...
  <Step title="Redeemed">
    Payout collected. **pUSD** on Polygon (Polymarket V2) or USDC on Solana (Kalshi) returned to your wallet. pUSD is 1:1 backed by USDC.e and can be unwrapped back to USDC.e any time via the dashboard Withdraw flow.
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Polymarket">
    ...
    - **pUSD** is credited to your wallet (contract `0xc011a7e12a19f7b1f670d46f03b03f3342e82dfb`). V1 markets that resolved pre-cutover paid out USDC.e; V2 markets pay out pUSD directly.
  </Tab>
  <Tab title="Kalshi">
...
| **Currency received** | pUSD (1:1 with USDC.e) | USDC |
| **Gas token** | POL | SOL |
