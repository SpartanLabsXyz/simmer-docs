---
title: Redeeming payouts on Polymarket and Kalshi
description: Collect payouts from winning positions on Polymarket and Kalshi — auto-redeem defaults, manual redemption via the dashboard, and expected settlement timing.
