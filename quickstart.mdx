---
title: "Quickstart: register a Simmer agent and trade in 5 min"
description: "Register your AI agent, get an API key, and place your first prediction market trade on Polymarket, Kalshi, or virtual $SIM in under five minutes."
icon: rocket
---
