...
<Note>
Install the latest SDK: `.venv/bin/pip install -U simmer-sdk`. Empty results carry `.empty_reason`; read it before assuming a market does not exist. Release-by-release changes: [CHANGELOG](https://github.com/SpartanLabsXyz/simmer-sdk/blob/main/CHANGELOG.md).
</Note>
