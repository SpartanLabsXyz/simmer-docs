---
title: Trading Guide
description: Step-by-step Simmer trading workflow — find prediction markets, evaluate liquidity, place orders, monitor positions, and exit on Polymarket and Kalshi.
icon: chart-line
---
