---
title: Open Source
description: Explore Simmer's open-source projects — the simmer-sdk Python package and simmer-mcp server on GitHub, PyPI, and npm, plus how to contribute.
icon: github
---
...
<CardGroup cols={2}>
  <Card title="npm" icon="npm" href="https://www.npmjs.com/package/simmer-mcp">
