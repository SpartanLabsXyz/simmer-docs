---
title: Simmer open-source repos — SDK, skills, and examples
description: Simmer's open-source projects on GitHub — the simmer-sdk Python package, published skills, example agents, and how to contribute PRs or file issues.
icon: github
---
