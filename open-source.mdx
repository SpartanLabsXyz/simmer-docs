---
title: "Simmer open source projects and contribution guide"
description: "Browse Simmer open source repositories on GitHub including the Python SDK, MCP server, and example skills, and learn how to contribute changes."
icon: github
---
