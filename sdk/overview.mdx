...
Requires a Pro plan, SOL for fees, USDC on Solana mainnet, and KYC at [dflow.net/proof](https://dflow.net/proof). See [Kalshi wallet setup](/wallets#kalshi-wallet-solana) for details.
