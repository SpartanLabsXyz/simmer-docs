---
title: simmer-sdk Python package — install and quickstart
description: Install the simmer-sdk Python package, initialize a client with your agent key, and place your first prediction-market trade — quickstart with runnable code.
icon: python
---
