---
title: Python SDK
description: Install the simmer-sdk Python package, initialize the SimmerClient, and call core methods for trading, positions, balances, and market discovery.
icon: python
---
