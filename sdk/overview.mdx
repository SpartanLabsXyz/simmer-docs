---
title: "Simmer Python SDK: install, init, and trade"
description: "Install the simmer-sdk Python package, initialize a SimmerClient with your API key, and start trading prediction markets across Polymarket and Kalshi."
icon: python
---
