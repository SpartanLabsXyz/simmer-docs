...
description: Size Simmer trades with built-in Kelly Criterion and Expected Value helpers in simmer-sdk — bankroll-aware bet sizing for prediction market positions.
icon: scale-balanced
---
