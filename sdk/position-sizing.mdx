---
title: "Position sizing in simmer-sdk: Kelly and EV helpers"
description: "Use the Kelly Criterion and Expected Value position sizing helpers shipped with simmer-sdk to size prediction market trades from edge and bankroll."
icon: scale-balanced
---
