---
title: "Balance pre-flight: catch underfunded wallets early"
description: "Use the simmer-sdk balance pre-flight helper to detect underfunded Polymarket or Kalshi wallets before placing orders and avoid wasted API calls."
icon: shield-halved
---
