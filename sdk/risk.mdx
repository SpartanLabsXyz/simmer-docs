...
description: Use ensure_can_trade() in simmer-sdk to catch underfunded wallets before placing orders — collateral-agnostic balance pre-flight for pUSD and USDC.e.
icon: shield-halved
---
