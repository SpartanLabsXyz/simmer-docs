...
description: "Get started with the Simmer REST API: base URL, Bearer token auth, the health endpoint, and per-key rate limits across Free, Pro, and Elite tiers."
icon: code
---
