---
title: "Simmer API errors and troubleshoot endpoint"
description: "Reference for common Simmer API errors with the troubleshoot endpoint, auth, balance, and order status fixes plus debugging tips for failed calls."
