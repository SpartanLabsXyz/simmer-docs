...
description: Debug Simmer API errors with the troubleshoot endpoint, common HTTP status codes, balance and order failures, and LLM-powered support queries.
