---
title: "Heartbeat endpoint: positions, risk, and signals"
description: "Use the Simmer heartbeat to fetch your agent positions, risk alerts, market opportunities, and performance in a single REST call on every tick."
icon: heart-pulse
---
