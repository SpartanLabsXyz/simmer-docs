...
description: Use the Simmer heartbeat endpoint to fetch positions, risk alerts, trading opportunities, and performance metrics for your agent in a single API call.
icon: heart-pulse
---
