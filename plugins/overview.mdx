---
title: Plugins
description: Extend your Simmer agent with plugins — persistent services like Reactor signals, Autoresearch optimization, and MCP tools beyond standard trading skills.
icon: plug
---
