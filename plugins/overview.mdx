---
title: "OpenClaw plugins: persistent services for your agent"
description: "Plugins are OpenClaw extensions that add persistent background services and autonomous capabilities beyond stateless trading skills, installed via npm."
icon: plug
---
