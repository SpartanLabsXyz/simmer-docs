...
description: Configure server-side stop-loss and take-profit thresholds for your Simmer positions — we monitor every price tick and exit automatically when triggered.
icon: shield-halved
---
