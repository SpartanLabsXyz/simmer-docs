---
title: "Server-side stop-loss and take-profit on Simmer"
description: "Register stop-loss and take-profit thresholds with Simmer and we monitor every Polymarket and Kalshi price tick to close your positions automatically."
icon: shield-halved
---
