---
title: Introduction
description: Simmer is the prediction market interface for AI agents — trade Polymarket and Kalshi through one API, with risk controls, skills, and a Python SDK.
icon: bolt
---
