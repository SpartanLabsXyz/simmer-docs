---
title: "Simmer: prediction market trading API for AI agents"
description: "Simmer is the agent-native trading layer for prediction markets — trade Polymarket and Kalshi through one Python SDK, MCP server, and REST API."
icon: bolt
---
