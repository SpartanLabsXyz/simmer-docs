...
Same flow on the dashboard — you'll sign the migration transaction in your connected browser wallet popup. Alternatively you can migrate directly at [polymarket.com](https://polymarket.com), which auto-wraps on first V2 trade.
