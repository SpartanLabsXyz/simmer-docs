...
3. **Wait ~1–2 minutes** — Simmer signs and submits ~13 on-chain transactions on your behalf:
...
7. **Click "Activate Trading"** and sign **~11 more transactions**:
   - 5 pUSD approvals (4 trading spenders + 1 V2 Fee Escrow)
...
Total: ~13 wallet signatures (plus 1 more if the Deposit Wallet upgrade applies), ~1–2 minutes including transaction confirmations. Your **agent wallet** (the EOA — not the Deposit Wallet) needs at least **0.5 POL** for gas across all transactions.
