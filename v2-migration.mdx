...
Total: ~10 wallet signatures, ~1–2 minutes including transaction confirmations. Your **agent wallet** (the EOA — not the Deposit Wallet) needs at least **0.5 POL** for gas across all transactions.
