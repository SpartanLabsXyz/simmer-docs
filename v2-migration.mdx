...
Total: ~13–14 wallet signatures, depending on whether the dashboard needs to deploy your Deposit Wallet, ~1–2 minutes including transaction confirmations. Your **agent wallet** (the EOA — not the Deposit Wallet) needs at least **0.1 POL** for gas across all transactions (0.5 POL gives comfortable headroom across the ~13–14 signatures).
