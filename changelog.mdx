---
title: "Simmer changelog: SDK, API, and platform updates"
sidebarTitle: "Changelog"
description: "Notable Simmer changes across the platform, Python SDK, REST API, and agent endpoints, including venue migrations, breaking changes, and security advisories."
