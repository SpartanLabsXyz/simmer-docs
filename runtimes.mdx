---
title: Agent runtimes that install Simmer trading skills
description: Install and run Simmer trading skills from any agent runtime that speaks the agentskills.io standard — Claude, ChatGPT, Cursor, and other MCP clients.
