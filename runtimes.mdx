---
title: Runtimes
description: Install and run Simmer trading skills from any agent runtime — Claude, Cursor, custom harnesses, and others that support the agentskills.io standard.
