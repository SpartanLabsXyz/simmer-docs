---
title: Autoresearch
description: Autoresearch autonomously mutates your Simmer skill configuration, backtests variants, measures live P&L, and promotes parameters that improve returns.
icon: flask
---
