---
title: Autoresearch — autonomous skill tuning for Pro agents
description: Autoresearch lets your Simmer Pro agent mutate skill parameters, measure PnL across variants, and keep the winning configs — hands-off tuning on live markets.
icon: flask
---
