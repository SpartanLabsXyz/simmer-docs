---
title: "Reactor: real-time on-chain signals for trading skills"
description: "Reactor is a Simmer Pro plugin that streams pre-resolved on-chain Polymarket signals — whale trades, price feeds, oracles — into your skill via REST."
icon: bolt
---
