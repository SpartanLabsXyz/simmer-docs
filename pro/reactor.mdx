---
title: Reactor
description: Reactor delivers real-time on-chain signals to your Simmer agent skills — whale trades, price feeds, oracle updates, liquidity events, and webhooks.
icon: bolt
---
