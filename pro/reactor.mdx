...
Reactor currently delivers copytrading signals. Your skill should still filter by `payload.type` on every poll so older or future signal types are ignored unless you explicitly support them.
